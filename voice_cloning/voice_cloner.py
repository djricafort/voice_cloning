...
from voice_cloning.audio_cleaning import Audio_Cleaner
...
class Voice_Cloner():
    ...
    def get_input_text(input_text):
        # get string input text here
        return 1

    def get_source_voice(source_voice):
        #get source speaker voice
        return 1
    ...
    def sythesize_voice(source_voice, script):
        ...
        parser.add_argument("-e", "--enc_model_fpath", type=Path,
                            default=ROOT_DIR + "/" + "encoder/saved_models/pretrained.pt",
                            help="Path to a saved encoder")
        parser.add_argument("-s", "--syn_model_dir", type=Path,
                            default=ROOT_DIR + "/" + "synthesizer/saved_models/logs-pretrained/",
                            help="Directory containing the synthesizer model")
        parser.add_argument("-v", "--voc_model_fpath", type=Path,
                            default=ROOT_DIR + "/" + "vocoder/saved_models/pretrained/pretrained.pt",
        ...
        try:
            ...
            trimmed_output_path = "static/cloned/" + time.strftime("%Y%m%d-%H%M%S") + "t.wav"
            subprocess.call(shlex.split('%s %s %s' % (script_path, str(fpath), str(trimmed_output_path))))
